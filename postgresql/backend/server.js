...
const pool = new Pool({
    connectionString: process.env.SUPABASE_DBURI,
        // || "postgresql://postgres.scapzmmddiwdkpjhhxuo:Nilesh13122@@aws-0-ap-southeast-1.pooler.supabase.com:6543/college" , // Use your database URL here
    ssl:false
});
...
// Login endpoint
app.post("https://authenticate-site.netlify.app/api/login", async (req, res) => {
